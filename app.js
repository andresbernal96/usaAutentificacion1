  ...
  new FacebookStrategy(
    {
      ...
      callbackURL: "https://usaregistro.herokuapp.com/users/auth/facebook/callback",
      profileFields: ["email", "displayName","gender","user_birthday"]
    },
          ...
          User.findOne(
            ...
            function (err, user) {
              ...
              if (user) {
                ...
                newUser.facebook.email = profile.user_birthday;
                newUser.save(
                  function (err) {
                    if (err)
                      throw err;
